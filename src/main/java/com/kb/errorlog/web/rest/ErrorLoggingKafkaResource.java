...
@RestController
@RequestMapping("/api/error-logging-kafka")
public class ErrorLoggingKafkaResource {
    private final Logger log = LoggerFactory.getLogger(ErrorLoggingKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public ErrorLoggingKafkaResource(KafkaProperties kafkaProperties) {
